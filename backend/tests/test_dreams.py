...
class _StubNarrativeEngine:
    ...
    def journal(self, *, title: str, transcript: str, mood: str | None, focus_points, tone):
        self.calls.append(
            {
                "title": title,
...
class _StubTranscriptionEngine:
    ...
    def transcribe(self, *, audio: bytes, prompt: str | None):
        self.calls.append({"audio": audio, "prompt": prompt})
        return TranscriptionResult(transcript=audio.decode("utf-8"), engine="stub", confidence=0.75)
...
def test_autogenerated_tags_and_highlights() -> None:
    ...
    payload = {
        ...
        "transcript": "Colours spiralled around a crystal forest with luminous wolves running beside me.",
        "tags": [],
        "mood": None,
    }
